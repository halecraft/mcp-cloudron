...
describe("cloudron_control_app tool", () => {
  ...
  describe("start action", () => {
    it("should start app successfully", async () => {
      ...
      mockFetch.mockResolvedValueOnce(mockSuccessResponse({ taskId }, 202))
    ...
    it("should handle app not found (404)", async () => {
      mockFetch.mockResolvedValueOnce(mockErrorResponse(404, "App not found"))
  ...
  describe("app state transitions", () => {
    it("should track state transition: running → stopped", async () => {
      ...
      mockFetch.mockResolvedValueOnce(mockSuccessResponse(runningApp, 200))
    ...
    it("should track state transition: stopped → running", async () => {
      ...
      mockFetch.mockResolvedValueOnce(mockSuccessResponse(stoppedApp, 200))
  ...
  describe("error handling", () => {
    it("should handle API authentication error (401)", async () => {
      mockFetch.mockResolvedValueOnce(mockErrorResponse(401, "Invalid token"))
    ...
    it("should handle network error", async () => {
      ...
      await expect(client.restartApp("app-test")).rejects.toThrow(
        "Network error",
      )
    })
  })
  ...
  describe("async operation tracking", () => {
    it("should return task ID for task_status tracking", async () => {
